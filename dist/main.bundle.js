...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__services_authentication_service_client__ = __webpack_require__("../../../../../src/app/services/authentication.service.client.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_24__services_user_service_client__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_26__services_website_service_client__["a" /* WebsiteService */], __WEBPACK_IMPORTED_MODULE_27__services_page_service_client__["a" /* PageService */], __WEBPACK_IMPORTED_MODULE_28__services_widget_service_client__["a" /* WidgetService */], __WEBPACK_IMPORTED_MODULE_8__services_test_service_client__["a" /* TestService */], __WEBPACK_IMPORTED_MODULE_31__services_flickr_service_client__["a" /* FlickrImageService */], __WEBPACK_IMPORTED_MODULE_29__services_shared_service_client__["a" /* SharedService */], __WEBPACK_IMPORTED_MODULE_25__services_authentication_service_client__["a" /* AuthenticationService */]],
...
var APP_ROUTES = [
    ...
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_4__components_user_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__services_authentication_service_client__["a" /* AuthenticationService */]] },
...
var PageNewComponent = (function () {
    ...
    PageNewComponent.prototype.newPage = function () {
        ...
        if (this.pageName != null && this.pageDescription != null) {
            var new_page = { name: this.pageName, _website: this.websiteId, description: this.pageDescription };
...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.logout = function () {
        var _this = this;
        this.userService.logout().subscribe(function (status) {
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.username != null && this.firstName != null && this.lastName != null && this.password != null && this.conf_password != null) {
            this.userService.register(this.username, this.password, this.firstName, this.lastName).subscribe(function (user) {
                _this.sharedService.user = user;
                _this.router.navigate(['/profile']);
            });
        }
...
var WebsiteNewComponent = (function () {
    ...
    WebsiteNewComponent.prototype.createWebsite = function () {
        ...
        if (this.websiteName != null && this.websiteDescription != null) {
            var new_website = { name: this.websiteName, _user: this.userId, description: this.websiteDescription };
...
var WidgetChooserComponent = (function () {
    ...
    WidgetChooserComponent.prototype.createWidget = function (type) {
        var _this = this;
        console.log(type);
        var new_widget = { type: type, _page: this.pageId, text: '' };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__widget_text_widget_text_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-edit/widget-text/widget-text.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    WidgetEditComponent.prototype.updateWidget = function () {
        switch (this.type) {
            ...
            case "YOUTUBE":
                ...
                break;
            case "TEXT":
                this.widgetTextComponent.updateWidget();
                break;
        }
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_6__widget_text_widget_text_component__["a" /* WidgetTextComponent */]),
    __metadata("design:type", typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__widget_text_widget_text_component__["a" /* WidgetTextComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__widget_text_widget_text_component__["a" /* WidgetTextComponent */]) === "function" && _d || Object)
...
WidgetEditComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__services_widget_service_client__["a" /* WidgetService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_widget_service_client__["a" /* WidgetService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _g || Object])
], WidgetEditComponent);
...
var WidgetImageComponent = (function () {
    ...
    WidgetImageComponent.prototype.updateWidget = function () {
        var _this = this;
        if (this.widgetText != '' && this.widgetText != null && this.widgetWidth != null && this.widgetUrl != null && this.widgetUrl != '') {
            this.widget.text = this.widgetText;
...
module.exports = "<div class='container big-boy'>\n  <div ng-switch-when=\"TEXT\">\n    Text\n    <input [(ngModel)]=\"text\" name=\"text\" class=\"form-control\"/>\n    Rows\n    <input [(ngModel)]=\"row\" name=\"row\" class=\"form-control\" type=\"number\"/>\n    Placeholder\n    <input [(ngModel)]=\"placeholder\" name=\"placeholder\" class=\"form-control\"/>\n    Formatted\n    <input [(ngModel)]=\"formatted\" name=\"formatted\" type=\"checkbox\"/>\n  <div *ngIf=\"errorFlag\"\n    class=\"alert alert-danger\">\n    Please fill out all of the fields\n  </div>\n  </div>\n</div>\n\n"
